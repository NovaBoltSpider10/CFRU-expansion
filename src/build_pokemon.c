...
const species_t gGeneralTrainerSpreads[NUM_TRAINER_CLASSES][NUM_BADGE_OPTIONS][NUM_MONS_PER_BADGE] = {
    ...
    [CLASS_ELITE_FOUR] = {
        ...
        [7] = {SPECIES_GENGAR_MEGA_Y, SPECIES_MORPEKO_HANGRY, SPECIES_APPLETUN, SPECIES_WYRDEER, SPECIES_GOURGEIST_M, SPECIES_KLANG, SPECIES_SCRAFTY, SPECIES_POLTEAGEIST_CHIPPED, SPECIES_CALYREX_SHADOW_RIDER, SPECIES_COBALION},
