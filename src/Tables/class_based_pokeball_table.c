...
const u8 gClassPokeBalls[NUM_TRAINER_CLASSES] =
	{
		...
		[CLASS_LASS] = BALL_TYPE_HEAL_BALL,
		[CLASS_SAILOR] = BALL_TYPE_DIVE_BALL,
		[CLASS_CAMPER] = BALL_TYPE_NEST_BALL,
		[CLASS_PICNICKER] = BALL_TYPE_FRIEND_BALL,
		[CLASS_POKEMANIAC] = BALL_TYPE_PREMIER_BALL,
		[CLASS_SUPER_NERD] = BALL_TYPE_TIMER_BALL,
		[CLASS_HIKER] = BALL_TYPE_HEAVY_BALL,
		[CLASS_BIKER] = BALL_TYPE_DUSK_BALL,
		[CLASS_BURGLAR] = BALL_TYPE_DUSK_BALL,
		[CLASS_ENGINEER] = BALL_TYPE_TIMER_BALL,
		[CLASS_FISHERMAN] = BALL_TYPE_LURE_BALL,
		[CLASS_SWIMMER_M] = BALL_TYPE_DIVE_BALL,
		[CLASS_CUE_BALL] = BALL_TYPE_DUSK_BALL,
		[CLASS_GAMER] = BALL_TYPE_LUXURY_BALL,
		[CLASS_BEAUTY] = BALL_TYPE_LOVE_BALL,
		[CLASS_SWIMMER_F] = BALL_TYPE_DIVE_BALL,
		[CLASS_PSYCHIC] = BALL_TYPE_DREAM_BALL,
		[CLASS_ROCKER] = BALL_TYPE_FAST_BALL,
		[CLASS_JUGGLER] = BALL_TYPE_REPEAT_BALL,
		[CLASS_TAMER] = BALL_TYPE_ULTRA_BALL,
		[CLASS_BIRD_KEEPER] = BALL_TYPE_QUICK_BALL,
		[CLASS_BLACK_BELT] = BALL_TYPE_LEVEL_BALL,
		...
		[CLASS_TEAM_ROCKET] = BALL_TYPE_DUSK_BALL,
		[CLASS_COOLTRAINER] = BALL_TYPE_ULTRA_BALL,
		[CLASS_ELITE_FOUR] = BALL_TYPE_ULTRA_BALL,
		[CLASS_GENTLEMAN] = BALL_TYPE_LUXURY_BALL,
		[CLASS_RIVAL_2] = BALL_TYPE_POKE_BALL,
		[CLASS_CHAMPION] = BALL_TYPE_POKE_BALL,
		[CLASS_CHANNELER] = BALL_TYPE_DREAM_BALL,
		[CLASS_TWINS] = BALL_TYPE_REPEAT_BALL,
		[CLASS_COOL_COUPLE] = BALL_TYPE_LOVE_BALL,
		[CLASS_YOUNG_COUPLE] = BALL_TYPE_HEAL_BALL,
		[CLASS_CRUSH_KIN] = BALL_TYPE_POKE_BALL,
		[CLASS_SIS_AND_BRO] = BALL_TYPE_FRIEND_BALL,
		[CLASS_PKMN_PROF] = BALL_TYPE_POKE_BALL,
		[CLASS_PLAYER] = BALL_TYPE_POKE_BALL,
		[CLASS_CRUSH_GIRL] = BALL_TYPE_HEAL_BALL,
		[CLASS_TUBER] = BALL_TYPE_DIVE_BALL,
		[CLASS_PKMN_BREEDER] = BALL_TYPE_FRIEND_BALL,
		[CLASS_PKMN_RANGER] = BALL_TYPE_SPORT_BALL,
		[CLASS_AROMA_LADY] = BALL_TYPE_FRIEND_BALL,
		[CLASS_RUIN_MANIAC] = BALL_TYPE_DUSK_BALL,
		[CLASS_LADY] = BALL_TYPE_LUXURY_BALL,
		[CLASS_PAINTER] = BALL_TYPE_CHERISH_BALL,
