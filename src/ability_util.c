...
{
	#if (defined SPECIES_FARFETCHD && SPECIES_GALLADE && SPECIES_GALLADE_MEGA && SPECIES_SAMUROTT_H && SPECIES_KLEAVOR && SPECIES_VELUZA)
	return species == SPECIES_FARFETCHD || species == SPECIES_GALLADE || species == SPECIES_GALLADE_MEGA || species == SPECIES_SAMUROTT_H || species == SPECIES_KLEAVOR || species == SPECIES_VELUZA;
	#else
	return FALSE;
	#endif
}
