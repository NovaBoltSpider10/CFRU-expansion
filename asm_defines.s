...
//Gen 9 Moves
.equ MOVE_AQUACUTTER, 0x39B
.equ MOVE_AQUASTEP, 0x39C
.equ MOVE_ARMORCANNON, 0x39D
.equ MOVE_AXEKICK, 0x39E
.equ MOVE_BITTERBLADE, 0x39F
.equ MOVE_BLAZINGTORQUE, 0x3A0
.equ MOVE_CHILLINGWATER, 0x3A1
.equ MOVE_CHILLYRECEPTION, 0x3A2
.equ MOVE_COLLISIONCOURSE, 0x3A3
.equ MOVE_COMBATTORQUE, 0x3A4
.equ MOVE_COMEUPPANCE, 0x3A5
.equ MOVE_DOODLE, 0x3A6
.equ MOVE_DOUBLESHOCK, 0x3A7
.equ MOVE_ELECTRODRIFT, 0x3A8
.equ MOVE_FILLETAWAY, 0x3A9
.equ MOVE_FLOWERTRICK, 0x3AA
.equ MOVE_GIGATONHAMMER, 0x3AB
.equ MOVE_GLAIVERUSH, 0x3AC
.equ MOVE_HYDROSTEAM, 0x3AD
.equ MOVE_HYPERDRILL, 0x3AE
.equ MOVE_ICESPINNER, 0x3AF
.equ MOVE_JETPUNCH, 0x3B0
.equ MOVE_KOWTOWCLEAVE, 0x3B1
.equ MOVE_LASTRESPECTS, 0x3B2
.equ MOVE_LUMINACRASH, 0x3B3
.equ MOVE_MAGICALTORQUE, 0x3B4
.equ MOVE_MAKEITRAIN, 0x3B5
.equ MOVE_MORTALSPIN, 0x3B6
.equ MOVE_NOXIOUSTORQUE, 0x3B7
.equ MOVE_ORDERUP, 0x3B8
.equ MOVE_POPULATIONBOMB, 0x3B9
.equ MOVE_POUNCE, 0x3BA
.equ MOVE_PSYBLADE, 0x3BB
.equ MOVE_RAGEFIST, 0x3BC
.equ MOVE_RAGINGBULL, 0x3BD
.equ MOVE_REVIVALBLESSING, 0x3BE
.equ MOVE_RUINATION, 0x3BF
.equ MOVE_SALTCURE, 0x3C0
.equ MOVE_SHEDTAIL, 0x3C1
.equ MOVE_SILKTRAP, 0x3C2
.equ MOVE_SNOWSCAPE, 0x3C3
.equ MOVE_SPICYEXTRACT, 0x3C4
.equ MOVE_SPINOUT, 0x3C5
.equ MOVE_TERABLAST, 0x3C6
.equ MOVE_TIDYUP, 0x3C7
.equ MOVE_TORCHSONG, 0x3C8
.equ MOVE_TRAILBLAZE, 0x3C9
.equ MOVE_TRIPLEDIVE, 0x3CA
.equ MOVE_TWINBEAM, 0x3CB
.equ MOVE_WICKEDTORQUE, 0x3CC
.equ MOVE_BLOODMOON, 0x3CD
.equ MOVE_UPPERHAND, 0x3CE
.equ MOVE_MATCHAGOTCHA, 0x3CF
.equ MOVE_SYRUPBOMB, 0x3D0
.equ MOVE_IVYCUDGEL, 0x3D1
.equ MOVE_ELECTROSHOT, 0x3D2
.equ MOVE_TERASTARSTORM, 0x3D3
.equ MOVE_FICKLEBEAM, 0x3D4
.equ MOVE_BURNINGBULWARK, 0x3D5
.equ MOVE_MIGHTYCLEAVE, 0x3D6
.equ MOVE_TACHYONCUTTER, 0x3D7
.equ MOVE_DRAGONCHEER, 0x3D8
.equ MOVE_MALIGNANTCHAIN, 0x3D9
.equ MOVE_THUNDERCLAP, 0x3DA
.equ MOVE_HARDPRESS, 0x3DB
.equ MOVE_ALLURINGVOICE, 0x3DC
.equ MOVE_TEMPERFLARE, 0x3DD
...
.equ SPECIES_GENGAR_MEGA_Y, 0x36D
...
.equ SPECIES_SPRIGATITO, 0x50E
.equ SPECIES_FLORAGATO, 0x50F
.equ SPECIES_MEOWSCARADA, 0x510
.equ SPECIES_FUECOCO, 0x511
.equ SPECIES_CROCALOR, 0x512
.equ SPECIES_SKELEDIRGE, 0x513
.equ SPECIES_QUAXLY, 0x514
.equ SPECIES_QUAXWELL, 0x515
.equ SPECIES_QUAQUAVAL, 0x516
.equ SPECIES_LECHONK, 0x517
.equ SPECIES_OINKOLOGNE, 0x518
.equ SPECIES_OINKOLOGNE_FEMALE, 0x519
.equ SPECIES_TAROUNTULA, 0x51A
.equ SPECIES_SPIDOPS, 0x51B
.equ SPECIES_NYMBLE, 0x51C
.equ SPECIES_LOKIX, 0x51D
.equ SPECIES_PAWMI, 0x51E
.equ SPECIES_PAWMO, 0x51F
.equ SPECIES_PAWMOT, 0x520
.equ SPECIES_TANDEMAUS, 0x521
.equ SPECIES_MAUSHOLD, 0x522
.equ SPECIES_MAUSHOLD_FOUR, 0x523
.equ SPECIES_FIDOUGH, 0x524
.equ SPECIES_DACHSBUN, 0x525
.equ SPECIES_SMOLIV, 0x526
.equ SPECIES_DOLLIV, 0x527
.equ SPECIES_ARBOLIVA, 0x528
.equ SPECIES_SQUAWKABILLY, 0x529
.equ SPECIES_SQUAWKABILLY_BLUE, 0x52A
.equ SPECIES_SQUAWKABILLY_YELLOW, 0x52B
.equ SPECIES_SQUAWKABILLY_WHITE, 0x52C
.equ SPECIES_NACLI, 0x52D
.equ SPECIES_NACLSTACK, 0x52E
.equ SPECIES_GARGANACL, 0x52F
.equ SPECIES_CHARCADET, 0x530
.equ SPECIES_ARMAROUGE, 0x531
.equ SPECIES_CERULEDGE, 0x532
.equ SPECIES_TADBULB, 0x533
.equ SPECIES_BELLIBOLT, 0x534
.equ SPECIES_WATTREL, 0x535
.equ SPECIES_KILOWATTREL, 0x536
.equ SPECIES_MASCHIFF, 0x537
.equ SPECIES_MABOSSTIFF, 0x538
.equ SPECIES_SHROODLE, 0x539
.equ SPECIES_GRAFAIAI, 0x53A
.equ SPECIES_BRAMBLIN, 0x53B
.equ SPECIES_BRAMBLEGHAST, 0x53C
.equ SPECIES_TOEDSCOOL, 0x53D
.equ SPECIES_TOEDSCRUEL, 0x53E
.equ SPECIES_KLAWF, 0x53F
.equ SPECIES_CAPSAKID, 0x540
.equ SPECIES_SCOVILLAIN, 0x541
.equ SPECIES_RELLOR, 0x542
.equ SPECIES_RABSCA, 0x543
.equ SPECIES_FLITTLE, 0x544
.equ SPECIES_ESPATHRA, 0x545
.equ SPECIES_TINKATINK, 0x546
.equ SPECIES_TINKATUFF, 0x547
.equ SPECIES_TINKATON, 0x548
.equ SPECIES_WIGLETT, 0x549
.equ SPECIES_WUGTRIO, 0x54A
.equ SPECIES_BOMBIRDIER, 0x54B
.equ SPECIES_FINIZEN, 0x54C
.equ SPECIES_PALAFIN, 0x54D
.equ SPECIES_PALAFIN_HERO, 0x54E
.equ SPECIES_VAROOM, 0x54F
.equ SPECIES_REVAVROOM, 0x550
.equ SPECIES_CYCLIZAR, 0x551
.equ SPECIES_ORTHWORM, 0x552
.equ SPECIES_GLIMMET, 0x553
.equ SPECIES_GLIMMORA, 0x554
.equ SPECIES_GREAVARD, 0x555
.equ SPECIES_HOUNDSTONE, 0x556
.equ SPECIES_FLAMIGO, 0x557
.equ SPECIES_CETODDLE, 0x558
.equ SPECIES_CETITAN, 0x559
.equ SPECIES_VELUZA, 0x55A
.equ SPECIES_DONDOZO, 0x55B
.equ SPECIES_TATSUGIRI, 0x55C
.equ SPECIES_TATSUGIRI_RED, 0x55D
.equ SPECIES_TATSUGIRI_YELLOW, 0x55E
.equ SPECIES_ANNIHILAPE, 0x55F
.equ SPECIES_CLODSIRE, 0x560
.equ SPECIES_FARIGIRAF, 0x561
.equ SPECIES_DUDUNSPARCE, 0x562
.equ SPECIES_DUDUNSPARCE_THREE, 0x563
.equ SPECIES_KINGAMBIT, 0x564
.equ SPECIES_GREAT_TUSK, 0x565
.equ SPECIES_SCREAM_TAIL, 0x566
.equ SPECIES_BRUTE_BONNET, 0x567
.equ SPECIES_FLUTTER_MANE, 0x568
.equ SPECIES_SLITHER_WING, 0x569
.equ SPECIES_SANDY_SHOCKS, 0x56A
.equ SPECIES_IRON_TREADS, 0x56B
.equ SPECIES_IRON_BUNDLE, 0x56C
.equ SPECIES_IRON_HANDS, 0x56D
.equ SPECIES_IRON_JUGULIS, 0x56E
.equ SPECIES_IRON_MOTH, 0x56F
.equ SPECIES_IRON_THORNS, 0x570
.equ SPECIES_FRIGIBAX, 0x571
.equ SPECIES_ARCTIBAX, 0x572
.equ SPECIES_BAXCALIBUR, 0x573
.equ SPECIES_GIMMIGHOUL, 0x574
.equ SPECIES_GIMMIGHOUL_ROAMING, 0x575
.equ SPECIES_GHOLDENGO, 0x576
.equ SPECIES_WO_CHIEN, 0x577
.equ SPECIES_CHIEN_PAO, 0x578
.equ SPECIES_TING_LU, 0x579
.equ SPECIES_CHI_YU, 0x57A
.equ SPECIES_ROARING_MOON, 0x57B
.equ SPECIES_IRON_VALIANT, 0x57C
.equ SPECIES_KORAIDON, 0x57D
.equ SPECIES_MIRAIDON, 0x57E
.equ SPECIES_WALKING_WAKE, 0x57F
.equ SPECIES_IRON_LEAVES, 0x580
.equ SPECIES_TAUROS_P, 0x581
.equ SPECIES_TAUROS_BLAZE_P, 0x582
.equ SPECIES_TAUROS_AQUA_P, 0x583
.equ SPECIES_WOOPER_P, 0x584
.equ SPECIES_URSALUNA_BLOODMOON, 0x585
.equ SPECIES_DIPPLIN, 0x586
.equ SPECIES_POLTCHAGEIST, 0x587
.equ SPECIES_POLTCHAGEIST_ARTISAN, 0x588
.equ SPECIES_SINISTCHA, 0x589
.equ SPECIES_SINISTCHA_MASTERPIECE, 0x58A
.equ SPECIES_OKIDOGI, 0x58B
.equ SPECIES_MUNKIDORI, 0x58C
.equ SPECIES_FEZANDIPITI, 0x58D
.equ SPECIES_OGERPON, 0x58E
.equ SPECIES_OGERPON_WELLSPRING_MASK, 0x58F
.equ SPECIES_OGERPON_HEARTHFLAME_MASK, 0x590
.equ SPECIES_OGERPON_CORNERSTONE_MASK, 0x591
.equ SPECIES_OGERPON_GREEN, 0x592
.equ SPECIES_OGERPON_BLUE, 0x593
.equ SPECIES_OGERPON_RED, 0x594
.equ SPECIES_OGERPON_GREY, 0x595
.equ SPECIES_ARCHALUDON, 0x596
.equ SPECIES_HYDRAPPLE, 0x597
.equ SPECIES_GOUGING_FIRE, 0x598
.equ SPECIES_RAGING_BOLT, 0x599
.equ SPECIES_IRON_BOULDER, 0x59A
.equ SPECIES_IRON_CROWN, 0x59B
.equ SPECIES_TERAPAGOS, 0x59C
.equ SPECIES_TERAPAGOS_TERASTAL, 0x59D
.equ SPECIES_TERAPAGOS_STELLAR, 0x59E
.equ SPECIES_PECHARUNT, 0x59F
.equ SPECIES_STARMIE_MEGA,         0x5A0
.equ SPECIES_ARTICUNO_MEGA,        0x5A1
.equ SPECIES_ZAPDOS_MEGA,          0x5A2
.equ SPECIES_MOLTRES_MEGA,         0x5A3
.equ SPECIES_DRAGONITE_MEGA,       0x5A4
.equ SPECIES_CROBAT_MEGA,          0x5A5
.equ SPECIES_BELLOSSOM_MEGA,       0x5A6
.equ SPECIES_RHYPERIOR_MEGA,       0x5A7
.equ SPECIES_ELECTIVIRE_MEGA,      0x5A8
.equ SPECIES_MAGMORTAR_MEGA,       0x5A9
.equ SPECIES_MEW_MEGA,       0x5AA
...
.equ ITEM_VENUSAURITE, 533
.equ ITEM_CHARIZARDITE_X, 534
.equ ITEM_CHARIZARDITE_Y, 535
.equ ITEM_BLASTOISINITE, 536
.equ ITEM_BEEDRILLITE, 537
.equ ITEM_PIDGEOTITE, 538
.equ ITEM_ALAKAZITE, 539
.equ ITEM_SLOWBRONITE, 540
.equ ITEM_GENGARITE, 541
.equ ITEM_KANGASKHANITE, 542
.equ ITEM_PINSIRITE, 543
.equ ITEM_GYARADOSITE, 544
.equ ITEM_AERODACTYLITE, 545
.equ ITEM_MEWTWONITE_X, 546
.equ ITEM_MEWTWONITE_Y, 547
.equ ITEM_AMPHAROSITE, 548
.equ ITEM_STEELIXITE, 549
.equ ITEM_SCIZORITE, 550
.equ ITEM_HERACRONITE, 551
.equ ITEM_HOUNDOOMINITE, 552
.equ ITEM_TYRANITARITE, 553
.equ ITEM_SCEPTILITE, 554
.equ ITEM_BLAZIKENITE, 555
.equ ITEM_SWAMPERTITE, 556
.equ ITEM_GARDEVOIRITE, 557
.equ ITEM_SABLENITE, 558
.equ ITEM_MAWILITE, 559
.equ ITEM_AGGRONITE, 560
.equ ITEM_MEDICHAMITE, 561
.equ ITEM_MANECTITE, 562
.equ ITEM_SHARPEDONITE, 563
.equ ITEM_CAMERUPTITE, 564
.equ ITEM_ALTARIANITE, 565
.equ ITEM_BANETTITE, 566
.equ ITEM_ABSOLITE, 567
.equ ITEM_GLALITITE, 568
.equ ITEM_SALAMENCITE, 569
.equ ITEM_METAGROSSITE, 570
.equ ITEM_LATIASITE, 571
.equ ITEM_LATIOSITE, 572
.equ ITEM_LOPUNNITE, 573
.equ ITEM_GARCHOMPITE, 574
.equ ITEM_LUCARIONITE, 575
.equ ITEM_ABOMASITE, 576
.equ ITEM_GALLADITE, 577
.equ ITEM_AUDINITE, 578
.equ ITEM_DIANCITE, 579

@ Z-Crystals

@ Apricorns
.equ ITEM_BLACK_APRICORN, 614
.equ ITEM_BLUE_APRICORN, 615
.equ ITEM_GREEN_APRICORN, 616
.equ ITEM_PINK_APRICORN, 617
.equ ITEM_RED_APRICORN, 618
.equ ITEM_WHITE_APRICORN, 619
.equ ITEM_YELLOW_APRICORN, 620

@ Relic Items
.equ ITEM_RELIC_COPPER, 621
.equ ITEM_RELIC_SILVER, 622
.equ ITEM_RELIC_GOLD, 623
.equ ITEM_RELIC_VASE, 624
.equ ITEM_RELIC_BAND, 625
.equ ITEM_RELIC_STATUE, 626
.equ ITEM_RELIC_CROWN, 627

@ Fossils
.equ ITEM_SKULL_FOSSIL, 628
.equ ITEM_ARMOR_FOSSIL, 629
.equ ITEM_COVER_FOSSIL, 630
.equ ITEM_PLUME_FOSSIL, 631
.equ ITEM_JAW_FOSSIL, 632
.equ ITEM_SAIL_FOSSIL, 633
.equ ITEM_FOSSILIZED_BIRD, 634
.equ ITEM_FOSSILIZED_FISH, 635
.equ ITEM_FOSSILIZED_DRAKE, 636
.equ ITEM_FOSSILIZED_DINO, 637

@ Random Normal Items
.equ ITEM_ODD_KEYSTONE, 638
.equ ITEM_BOTTLE_CAP, 639
.equ ITEM_GOLD_BOTTLE_CAP, 640
.equ ITEM_WISHING_PIECE, 641

@ EV Gain Items
.equ ITEM_POWER_BRACER, 642
.equ ITEM_POWER_BELT, 643
.equ ITEM_POWER_LENS, 644
.equ ITEM_POWER_BAND, 645
.equ ITEM_POWER_ANKLET, 646
.equ ITEM_POWER_WEIGHT, 647

@ New Incense
.equ ITEM_LUCK_INCENSE, 648
.equ ITEM_FULL_INCENSE, 649
.equ ITEM_ODD_INCENSE, 650
.equ ITEM_PURE_INCENSE, 651
.equ ITEM_ROCK_INCENSE, 652
.equ ITEM_ROSE_INCENSE, 653
.equ ITEM_WAVE_INCENSE, 654

@ Gems
.equ ITEM_NORMAL_GEM, 655
.equ ITEM_FIGHTING_GEM, 656
.equ ITEM_FLYING_GEM, 657
.equ ITEM_POISON_GEM, 658
.equ ITEM_GROUND_GEM, 659
.equ ITEM_ROCK_GEM, 660
.equ ITEM_BUG_GEM, 661
.equ ITEM_GHOST_GEM, 662
.equ ITEM_STEEL_GEM, 663
.equ ITEM_FIRE_GEM, 664
.equ ITEM_WATER_GEM, 665
.equ ITEM_GRASS_GEM, 666
.equ ITEM_ELECTRIC_GEM, 667
.equ ITEM_PSYCHIC_GEM, 668
.equ ITEM_ICE_GEM, 669
.equ ITEM_DRAGON_GEM, 670
.equ ITEM_DARK_GEM, 671
.equ ITEM_FAIRY_GEM, 672

@ New Battle Hold Items
.equ ITEM_WIDE_LENS, 673
.equ ITEM_MUSCLE_BAND, 674
.equ ITEM_WISE_GLASSES, 675
.equ ITEM_EXPERT_BELT, 676
.equ ITEM_LIGHT_CLAY, 677
.equ ITEM_LIFE_ORB, 678
.equ ITEM_POWER_HERB, 679
.equ ITEM_TOXIC_ORB, 680
.equ ITEM_FLAME_ORB, 681
.equ ITEM_QUICK_POWDER, 682
.equ ITEM_FOCUS_SASH, 683
.equ ITEM_ZOOM_LENS, 684
.equ ITEM_METRONOME, 685
.equ ITEM_IRON_BALL, 686
.equ ITEM_LAGGING_TAIL, 687
.equ ITEM_DESTINY_KNOT, 688
.equ ITEM_BLACK_SLUDGE, 689
.equ ITEM_ICY_ROCK, 690
.equ ITEM_SMOOTH_ROCK, 691
.equ ITEM_HEAT_ROCK, 692
.equ ITEM_DAMP_ROCK, 693
.equ ITEM_GRIP_CLAW, 694
.equ ITEM_CHOICE_SCARF, 695
.equ ITEM_CHOICE_SPECS, 696
.equ ITEM_STICKY_BARB, 697
.equ ITEM_SHED_SHELL, 698
.equ ITEM_BIG_ROOT, 699
.equ ITEM_EVIOLITE, 700
.equ ITEM_FLOAT_STONE, 701
.equ ITEM_ROCKY_HELMET, 702
.equ ITEM_AIR_BALLOON, 703
.equ ITEM_RED_CARD, 704
.equ ITEM_RING_TARGET, 705
.equ ITEM_BINDING_BAND, 706
.equ ITEM_ABSORB_BULB, 707
.equ ITEM_CELL_BATTERY, 708
.equ ITEM_EJECT_BUTTON, 709
.equ ITEM_WEAKNESS_POLICY, 710
.equ ITEM_ASSAULT_VEST, 711
.equ ITEM_LUMINOUS_MOSS, 712
.equ ITEM_SNOWBALL, 713
.equ ITEM_SAFETY_GOGGLES, 714
.equ ITEM_ADRENALINE_ORB, 715
.equ ITEM_TERRAIN_EXTENDER, 716
.equ ITEM_PROTECTIVE_PADS, 717
.equ ITEM_ELECTRIC_SEED, 718
.equ ITEM_GRASSY_SEED, 719
.equ ITEM_MISTY_SEED, 720
.equ ITEM_PSYCHIC_SEED, 721
.equ ITEM_EJECT_PACK, 722
.equ ITEM_ROOM_SERVICE, 723
.equ ITEM_BLUNDER_POLICY, 724
.equ ITEM_HEAVY_DUTY_BOOTS, 725
.equ ITEM_UTILITY_UMBRELLA, 726
.equ ITEM_THROAT_SPRAY, 727
.equ ITEM_ABILITY_CAPSULE, 728
.equ ITEM_ABILITY_PATCH, 729
.equ ITEM_AUSPICIOUS_ARMOR, 730
.equ ITEM_MALICIOUS_ARMOR, 731
.equ ITEM_BLACK_AUGURITE, 732
.equ ITEM_METAL_ALLOY, 733
.equ ITEM_PEAT_BLOCK, 734
.equ ITEM_LEADERS_CREST, 735
.equ ITEM_GIMMIGHOUL_COIN, 736
.equ ITEM_SYRUPY_APPLE, 737
.equ ITEM_CLEAR_AMULET, 738
.equ ITEM_COVERT_CLOAK, 739
.equ ITEM_LOADED_DICE, 740
.equ ITEM_PUNCHING_GLOVE, 741
.equ ITEM_REINS_OF_UNITY, 742
.equ ITEM_BOOSTER_ENERGY, 743
.equ ITEM_WELLSPRING_MASK, 744
.equ ITEM_HEARTHFLAME_MASK, 745
.equ ITEM_CORNERSTONE_MASK, 746
.equ ITEM_LONELY_MINT, 747
.equ ITEM_ADAMANT_MINT, 748
.equ ITEM_NAUGHTY_MINT, 749
.equ ITEM_BRAVE_MINT, 750
.equ ITEM_BOLD_MINT, 751
.equ ITEM_IMPISH_MINT, 752
.equ ITEM_LAX_MINT, 753
.equ ITEM_RELAXED_MINT, 0
.equ ITEM_MODEST_MINT, 0
.equ ITEM_MILD_MINT, 0
.equ ITEM_RASH_MINT, 0
.equ ITEM_QUIET_MINT, 0
.equ ITEM_CALM_MINT, 0
.equ ITEM_GENTLE_MINT, 0
.equ ITEM_CAREFUL_MINT, 0
.equ ITEM_SASSY_MINT, 0
.equ ITEM_TIMID_MINT, 0
.equ ITEM_HASTY_MINT, 0
.equ ITEM_JOLLY_MINT, 0
.equ ITEM_NAIVE_MINT, 0
.equ ITEM_SERIOUS_MINT, 767
.equ ITEM_POKEVIAL, 768
.equ ITEM_EVIV_DISPLAYER, 769
.equ ITEM_CATCHING_CHARM, 770
.equ ITEM_HISUI_ROCK, 771
.equ ITEM_UNREMARKABLE_TEACUP, 772
.equ ITEM_MASTERPIECE_TEACUP, 773
.equ ITEM_TERA_ORB, 774
.equ ITEM_PORTABLE_PC, 775

@ Unused Items
.equ ITEM_NORMALIUM_Z, 580
.equ ITEM_FIGHTINIUM_Z, 581
.equ ITEM_FLYINIUM_Z, 582
.equ ITEM_POISONIUM_Z, 583
.equ ITEM_GROUNDIUM_Z, 584
.equ ITEM_ROCKIUM_Z, 585
.equ ITEM_BUGINIUM_Z, 586
.equ ITEM_GHOSTIUM_Z, 587
.equ ITEM_STEELIUM_Z, 588
.equ ITEM_FIRIUM_Z, 589
.equ ITEM_WATERIUM_Z, 590
.equ ITEM_GRASSIUM_Z, 591
.equ ITEM_ELECTRIUM_Z, 592
.equ ITEM_PSYCHIUM_Z, 593
.equ ITEM_ICIUM_Z, 594
.equ ITEM_DRAGONIUM_Z, 595
.equ ITEM_DARKINIUM_Z, 596
.equ ITEM_FAIRIUM_Z, 597
.equ ITEM_ALORAICHIUM_Z, 598
.equ ITEM_DECIDIUM_Z, 599
.equ ITEM_EEVIUM_Z, 600
.equ ITEM_INCINIUM_Z, 601
.equ ITEM_KOMMONIUM_Z, 602
.equ ITEM_LUNALIUM_Z, 603
.equ ITEM_LYCANIUM_Z, 604
.equ ITEM_MARSHADIUM_Z, 605
.equ ITEM_MEWNIUM_Z, 606
.equ ITEM_MIMIKIUM_Z, 607
.equ ITEM_PIKANIUM_Z, 608
.equ ITEM_PIKASHUNIUM_Z, 609
.equ ITEM_PRIMARIUM_Z, 610
.equ ITEM_SNORLIUM_Z, 611
.equ ITEM_SOLGANIUM_Z, 612
.equ ITEM_TAPUNIUM_Z, 613
.equ ITEM_BUTTERFRITE,          776
.equ ITEM_MACHAMPITE,           777
.equ ITEM_GENGARITE_X,          778
.equ ITEM_STARMINITE,             779
.equ ITEM_LAPRASITE,            780
.equ ITEM_ARTICUNITE,           781
.equ ITEM_ZAPDOSITE,            782
.equ ITEM_MOLTRESITE,           783
.equ ITEM_DRAGONINITE,          784
.equ ITEM_CROBATITE,            785
.equ ITEM_BELLOSSOMITE,         786
.equ ITEM_RHYPERIORITE,         787
.equ ITEM_ELECTIVIRITE,         788
.equ ITEM_MAGMORTARITE,         789
.equ ITEM_KINGLERITE,           790
.equ ITEM_SNORLAXITE,           791
.equ ITEM_MEWNITE,              792
.equ ITEM_SHINY_SPACE15, 793
.equ ITEM_SHINY_SPACE16, 794
.equ ITEM_SHINY_SPACE17, 795
.equ ITEM_SHINY_SPACE18, 796
.equ ITEM_SHINY_SPACE19, 797
